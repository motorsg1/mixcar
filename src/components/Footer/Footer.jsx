      ...
      <div className="container-fluid">
              ...
              <div className="footer-widget">
                ...
                <div className="menu-container">
                  <ul>
                    ...
                    <li>
                      <Link href="/maxus-brand-category">
                        <span>
                          MAXUS
                          <svg
                            width={10}
                ...
                <div className="app-download">
                  <ul>
                    <li>
                      <a href="#">
                        <Image
                          src="/assets/img/mixcar/icon/google-app.svg"
                          alt="Google App"
                          width={200}
                          height={100}
                        />
                    ...
                    <li>
                      <a href="#">
                        <Image
                          src="/assets/img/mixcar/icon/apple-app.svg"
                          alt="Apple App"
                          width={200}
                          height={100}
                        />
        ...
        <div className="footer-center">
          ...
          <div className="contact-area">
            <div className="hotline-area">
              <div className="icon">
                <Image
                  src="/assets/img/mixcar/icon/hotline-icon.svg"
                  alt="Hotline Icon"
                  width={32}
                  height={32}
                />
            ...
            <div className="hotline-area">
              <div className="icon">
                <Image
                  src="/assets/img/mixcar/icon/mail2.svg"
                  alt="Mail Icon"
                  width={32}
                  height={32}
                />
        ...
        <div className="footer-btm">
          <div className="copyright-area">
            <p>
              &copy; {new Date().getFullYear()} <a href="#">Mixcar</a> | Design
              By <a href="#">Mark & Aarif</a>
            </p>
          </div>
