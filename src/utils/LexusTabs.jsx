...
const LexusBrand = () => {
  ...
  const fetchAcfData = async () => {
    try {
      const response = await axios.get(`${apiBaseUrl}wc/v3/products?acf_format=standard&brand=Lexus`, {
        auth: apiAuth,
      });
  ...
  const fetchProducts = async () => {
    setLoading(true);
    try {
      const url = `${apiBaseUrl}wc/v3/products?brand=Lexus&page=${currentPage}&acf_format=standard`;
      ...
      if (response.data.length === 0) {
        ...
        const newAcfData = await axios.get(`${apiBaseUrl}wc/v3/products?acf_format=standard&brand=Lexus&page=${currentPage}`, {
          auth: apiAuth,
        });
